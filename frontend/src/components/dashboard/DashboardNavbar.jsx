...
import { get_notification, seen_notification } from '../../store/actions/Dashboard/dashboardAction';
...
const DashboardNavbar = () => {
  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg bg-dark fixed-top border-bottom border-body" data-bs-theme="dark">
                ...
                <li className="nav-item dropdown  ">
...

                    {
                        ...
                        notifications.map((n,i) => (
                            <li key={i} 
                                style={n.status === 'seen' ? '' : {fontWeight:"bold",backgroundColor:"#232f34"} }  
                                  >
                                <a className="dropdown-item" href="#">
                                <Link to={`/article/detail/${n.slug}`} 
