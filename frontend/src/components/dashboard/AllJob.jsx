...
import { get_job } from '../../store/actions/Dashboard/jobAction';
...
const AllJob = () => {
  ...
  // console.log(currentPage);
    ...
    const { allJob, jobSuccessMessage } = useSelector(state=>state.dashboardJob);
  // console.log(allJob);
                ...
                <tbody>
                    {
                        ...
                        <tr className="accordion-toggle collapsed"  
                            ...
                            <span className="dropdown-header"></span>
                                ...
                                <Link to={`/dashboard/job/edit/${j.jobSlug}`} >
